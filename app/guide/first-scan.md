...
2. Enter Field of View (FOV) scanning mode, press the shutter button to capture a photo and start scanning. The app will show the decoding result from the captured photo. Press "Continue" to scan more barcodes.
...
3. After pressing "Continue", the app will reenter the live capturing interface, with the previous decoding result displayed in the bottom‑left corner.
